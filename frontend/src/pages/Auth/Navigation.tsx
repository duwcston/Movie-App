                ...
                <div className="relative">
                    ...
                    {!userInfo && (
                        <ul className="flex justify-between items-center">
                            <li>
                                <Link to="/login" className="flex items-center transition-transform transform hover:translate-x-2 mb-[2rem]">
                            ...
                            <li>
                                <Link to="/register" className="flex items-center transition-transform transform hover:translate-x-2 mb-[2rem]">
