        ...
        <div className="fixed bottom-10 rounded-lg bg-gray-800 text-white w-1/3 max-w-[800px] mx-auto p-4 z-50 transform -translate-x-1/2 left-1/2">
            <section className="flex justify-between items-center">
                <div className="flex justify-between items-center">
                    ...
                    <Link to="/movies" className="flex items-center transition-transform transform hover:-translate-y-2 ml-[1rem]">
                        <MdOutlineLocalMovies className="" size={26} />
                        <span className="hidden nav-item-name mt-[3rem]">Shop</span>
                    </Link>
                </div>
                <div className="relative">
                    <button onClick={toggleDropdown} className="text-gray-800 focus:outline-none flex items-center">
                        {userInfo ? (
